...
</a> </div> </div> </div> </div> ${renderScript($$result, "C:/laragon/www/sisit-niis/src/pages/unit/sdit2/CTA.astro?astro&type=script&index=0&lang.ts")} </section>`;
}, "C:/laragon/www/sisit-niis/src/pages/unit/sdit2/CTA.astro", void 0);

const $$file = "C:/laragon/www/sisit-niis/src/pages/unit/sdit2/CTA.astro";
const $$url = "/unit/sdit2/CTA";
