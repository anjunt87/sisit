...
const kompetensi = [
  {
    icon: "fa-quran",
    text: "Mengenal huruf hijaiyah dan mampu membaca Al-Qur'an dasar (Iqra/UMMI level awal)"
  },
  {
    icon: "fa-book-open",
    text: "Menghafal doa-doa harian dan surat pendek pilihan (Juz 30 dasar)"
  },
  {
    icon: "fa-hands-praying",
    text: "Terbiasa melaksanakan adab dan ibadah dasar (doa, salam, shalat dengan bimbingan)"
  },
  {
    icon: "fa-child",
    text: "Memiliki kemandirian dasar (makan, berpakaian, merapikan barang sendiri)"
  },
  {
    icon: "fa-heart",
    text: "Menunjukkan akhlak mulia: jujur, sopan, sabar, dan sayang teman"
  },
  {
    icon: "fa-comments",
    text: "Mampu berkomunikasi sederhana dalam Bahasa Indonesia dan pengenalan Bahasa Inggris dasar"
  },
  {
    icon: "fa-language",
    text: "Mengenal kosakata bilingual dasar melalui lagu, permainan, dan aktivitas sehari-hari"
  },
  {
    icon: "fa-paint-brush",
    text: "Mengembangkan kreativitas melalui seni, gambar, dan aktivitas eksplorasi"
  },
  {
    icon: "fa-running",
    text: "Mengembangkan motorik kasar dan halus melalui aktivitas fisik dan permainan edukatif"
  },
  {
    icon: "fa-globe",
    text: "Mengenal lingkungan sekitar dan nilai-nilai dasar kehidupan sosial secara Islami"
  }
];
const categories = [
  "Semua",
...
export { prosesPembelajaran as a, statistik as b, categories as c, kompetensi as d, gallery as g, identitas as i, keunggulan as k, pimpinan as p, stats as s };
