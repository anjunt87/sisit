...
const $$CTA = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`<!-- ╔══════════════════════════════════════╗ --><!-- ║              CTA SECTION            ║ --><!-- ╚══════════════════════════════════════╝ -->${maybeRenderHead()}<section class="py-20 pb-24 bg-white"> <div class="max-w-5xl mx-auto px-6"> <div class="relative bg-gradient-to-br from-orange-800 to-orange-900 rounded-3xl p-12 text-center overflow-hidden"> <div class="absolute inset-0 pointer-events-none" style="background-image:
            radial-gradient(circle at 10% 90%, rgba(255,255,255,0.04) 0%, transparent 50%),
            radial-gradient(circle at 90% 10%, rgba(16,185,129,0.1) 0%, transparent 40%)"></div> <div class="relative"> <i class="fas fa-envelope-open-text text-4xl text-amber-300 block mb-5"></i> <h3 class="font-serif text-3xl font-bold text-white mb-3">
Tertarik Bergabung?
</h3> <p class="text-white/75 text-base leading-relaxed max-w-md mx-auto mb-8">
Daftarkan putra-putri Anda di TK Nurul Imam Islamic School Karawang
          dan wujudkan impian bersama kami.
...
</a> </div> </div> </div> </div> ${renderScript($$result, "C:/laragon/www/sisit-niis/src/pages/unit/tkit3/CTA.astro?astro&type=script&index=0&lang.ts")} </section>`;
}, "C:/laragon/www/sisit-niis/src/pages/unit/tkit3/CTA.astro", void 0);

const $$file = "C:/laragon/www/sisit-niis/src/pages/unit/tkit3/CTA.astro";
const $$url = "/unit/tkit3/CTA";
