...
Mendidik generasi Qurani yang beriman, bertaqwa, berakhlak mulia,
          ...
          bilingual.
</p> <div class="flex flex-wrap gap-3"> <span class="inline-flex items-center gap-1.5 bg-amber-400/20 border border-amber-300/40 text-amber-300 text-sm font-bold px-3 py-1.5 rounded-full"> <i class="fas fa-award"></i> Akreditasi A
...
}, "C:/laragon/www/sisit-niis/src/pages/unit/smpit/Hero.astro", void 0);

const $$file = "C:/laragon/www/sisit-niis/src/pages/unit/smpit/Hero.astro";
const $$url = "/unit/smpit/Hero";
