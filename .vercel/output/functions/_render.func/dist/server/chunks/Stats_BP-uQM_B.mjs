...
0
</span> <span class="text-sm text-slate-600 font-medium mt-1"> ${stat.label} </span> </div> ${i < stats.length - 1 && renderTemplate`<div class="w-px h-10 bg-slate-200 hidden sm:block"></div>`}` })}`)} </div> </div> </section> ${renderScript($$result, "C:/laragon/www/sisit-niis/src/pages/unit/sdit2/Stats.astro?astro&type=script&index=0&lang.ts")}`;
}, "C:/laragon/www/sisit-niis/src/pages/unit/sdit2/Stats.astro", void 0);

const $$file = "C:/laragon/www/sisit-niis/src/pages/unit/sdit2/Stats.astro";
const $$url = "/unit/sdit2/Stats";
