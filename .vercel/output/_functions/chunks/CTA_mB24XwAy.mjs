...
Daftarkan putra-putri Anda di SMAIT Bilingual Nurul Imam Karawang dan
...
</a> </div> </div> </div> </div> ${renderScript($$result, "C:/laragon/www/sisit-niis/src/pages/unit/smait/CTA.astro?astro&type=script&index=0&lang.ts")} </section>`;
}, "C:/laragon/www/sisit-niis/src/pages/unit/smait/CTA.astro", void 0);

const $$file = "C:/laragon/www/sisit-niis/src/pages/unit/smait/CTA.astro";
const $$url = "/unit/smait/CTA";
