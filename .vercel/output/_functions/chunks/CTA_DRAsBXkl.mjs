...
const $$CTA = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`<!-- ╔══════════════════════════════════════╗ --><!-- ║        9. CTA SECTION                ║ --><!-- ╚══════════════════════════════════════╝ -->${maybeRenderHead()}<section class="py-20 pb-24 bg-white"> <div data-animate="fade-up" data-delay="200" class="max-w-5xl mx-auto px-6"> <div class="relative bg-gradient-to-br from-emerald-800 to-emerald-900 rounded-3xl p-12 text-center overflow-hidden"> <div class="absolute inset-0 pointer-events-none" style="background-image:
...
Daftarkan putra-putri Anda di SDIT Nurul Imam Karawang dan wujudkan
          impian bersama kami.
...
</a> </div> </div> </div> </div> ${renderScript($$result, "C:/laragon/www/sisit-niis/src/pages/unit/sdit3/CTA.astro?astro&type=script&index=0&lang.ts")} </section>`;
}, "C:/laragon/www/sisit-niis/src/pages/unit/sdit3/CTA.astro", void 0);

const $$file = "C:/laragon/www/sisit-niis/src/pages/unit/sdit3/CTA.astro";
const $$url = "/unit/sdit3/CTA";
