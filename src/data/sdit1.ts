...
// ================================
export const visi =
  "Terwujudnya lembaga pendidikan rujukan yang mampu mengembangkan potensi peserta didik dan menghasilkan Generasi Rabbani.";

export const misi = [
  "Menanamkan tauhid dan akhlak mulia dalam setiap aktivitas belajar.",
  "Meningkatkan kemampuan akademik berbasis project learning.",
  "Menumbuhkan kemandirian dan jiwa kepemimpinan siswa.",
  "Meningkatkan kompetensi pendidik dan tenaga kependidikan.",
  "Menyelenggarakan pendidikan berkualitas dan terjangkau.",
  "Mengintegrasikan kurikulum nasional dengan nilai Islam.",
];
